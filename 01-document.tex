...
\section{Estudo de Profecias ``Segundo Deus''}
    ...
    Exemplos de violação deste último item incluem: (1)~o emprego da carta aos Efésios, ainda à época não escrita, ao  invés  do
    Deuteronômio, para explicar quem são os \bQuote{escolhidos} em Mateus 24,  (2)~o  emprego  do  Apocalipse  para  explicar  o
    termo-chave \bQuote{trombeta} em 1Co~15, ao invés da própria carta, no capítulo anterior, etc.

    Conclui-se, portanto, que o estudo de profecias conduzido ``segundo Deus,'' é sem malícia no trato com a tradição de Deus; é
