...
\section{Introdução}
    ...
    \textsc{Este  estudo  aborda  o  assunto}  do  ``tempo  de  angústia  para  Jacó,''   profetizado   \textbf{pelos   profetas
    {\addfontfeature{FakeSlant=0.2} Jeremias} e \textsc{Daniel}, e referido em profecia dada pelo \textsl{Senhor Jesus}} como  o
    período de ``grande tribulação,'' passagens das Escrituras que lêem, em ordem cronológica\footnote{Uma vez  que  Jeremias  é
    citado por Daniel, conforme Dn~9.2, e que Daniel é citado pelo Senhor Jesus,  conforme  Mt~24.15,  a  ordem  cronológica  é:
    Jeremias -- Daniel -- Senhor Jesus.}:
